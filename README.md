...
* **Dual Difficulty Support:** Switch between **Normal** and **Insanity** difficulty with a single toggle.
* **Verified Data:** All 5 safe combinations and major puzzle solutions (Office, Research, Security) are up-to-date.
...
* **Theme:** Resident Evil inspired "Biohazard" aesthetic.
* **Hosting:** Hosted via GitHub Pages for 100% uptime and transparency.
